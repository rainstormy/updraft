...
describe.each`
	...
	${"2017-04-15"} | ${"--files lib/*.md --release-version 1.0.1-beta.1"}                       | ${[aPromotableMarkdownChangelogA("lib/RELEASES.md")]}                                                                                                                                                                                            | ${["RELEASES.md is not a supported filename and must be renamed to 'CHANGELOG.md' in Updraft v2.0.0."]}                                                                                                         | ${[aPromotedMarkdownChangelogA("lib/RELEASES.md", "1.0.1-beta.1", "2017-04-15")]}
	...
	${"2017-12-27"} | ${"--files **/*.md **/package.json --release-version 9.1.0"}               | ${[aPromotableMarkdownChangelogB("packages/apples/LOG.md"), aPromotableMarkdownChangelogD("packages/oranges/CHANGELOG.md"), aPromotablePackageJsonB("packages/oranges/package.json"), aPromotablePackageJsonD("packages/peaches/package.json")]} | ${["LOG.md is not a supported filename and must be renamed to 'CHANGELOG.md' in Updraft v2.0.0."]}                                                                                                              | ${[aPromotedMarkdownChangelogB("packages/apples/LOG.md", "9.1.0", "2017-12-27"), aPromotedMarkdownChangelogD("packages/oranges/CHANGELOG.md", "9.1.0", "2017-12-27"), aPromotedPackageJsonB("packages/oranges/package.json", "9.1.0"), aPromotedPackageJsonD("packages/peaches/package.json", "9.1.0")]}
`(
