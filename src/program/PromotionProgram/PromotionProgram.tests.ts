...
describe.each`
	...
	${"2017-03-23"} | ${"--files CHANGELOG.adoc --release-version 0.6.0"}                                                                                                              | ${"CHANGELOG.adoc did not match any supported files."}
	${"2017-07-03"} | ${"--release-version v1.0.4 --files package.json CHANGELOG.adoc"}                                                                                                | ${"package.json, CHANGELOG.adoc did not match any supported files."}
	${"2017-08-21"} | ${"--files packages/**/CHANGELOG.md --files packages/**/package.json --release-version 0.7.9+8d1de5a9"}                                                          | ${"packages/**/CHANGELOG.md, packages/**/package.json did not match any supported files."}
	${"2017-11-14"} | ${"--release-version 2.2.0-alpha.1 --files *.adoc *.md package.json"}                                                                                            | ${"*.adoc, *.md, package.json did not match any supported files."}
	${"2018-03-10"} | ${"--release-files CHANGELOG.md --release-version 1.7.1"}                                                                                                        | ${"CHANGELOG.md did not match any supported files."}
	${"2018-06-26"} | ${"--release-version 0.2.1 --release-files lib/CHANGELOG.md lib/package.json"}                                                                                   | ${"lib/CHANGELOG.md, lib/package.json did not match any supported files."}
	${"2018-09-07"} | ${"--prerelease-files packages/**/CHANGELOG.adoc packages/**/package.json --release-version 1.3.8+e60e77fc"}                                                     | ${"packages/**/CHANGELOG.adoc, packages/**/package.json did not match any supported files."}
	${"2018-11-19"} | ${"--release-version release/3.1.0-beta.2 --prerelease-files package.json *.adoc *.md"}                                                                          | ${"package.json, *.adoc, *.md did not match any supported files."}
	${"2019-03-03"} | ${"--files CHANGELOG.adoc --prerelease-files package.json --release-version 0.6.0"}                                                                              | ${"CHANGELOG.adoc did not match any supported files."}
	${"2019-05-18"} | ${"--release-version 1.0.4 --prerelease-files CHANGELOG.md --files package.json CHANGELOG.adoc"}                                                                 | ${"package.json, CHANGELOG.adoc did not match any supported files."}
	${"2019-07-30"} | ${"--files packages/**/CHANGELOG.md packages/**/package.json --release-files packages/**/CHANGELOG.adoc --release-version 0.7.9+8d1de5a9"}                       | ${"packages/**/CHANGELOG.md, packages/**/package.json did not match any supported files."}
	${"2019-12-20"} | ${"--release-version 2.2.0-alpha.1 --release-files CHANGELOG.adoc --files *.adoc *.md package.json"}                                                             | ${"*.adoc, *.md, package.json did not match any supported files."}
	${"2020-04-03"} | ${"--files CHANGELOG.md --release-version v1.7.1 --release-files package.json"}                                                                                  | ${"CHANGELOG.md, package.json did not match any supported files."}
	${"2020-07-24"} | ${"--release-version 0.2.1 --release-files lib/CHANGELOG.adoc --files lib/CHANGELOG.md --release-files lib/package.json"}                                        | ${"lib/CHANGELOG.md, lib/CHANGELOG.adoc, lib/package.json did not match any supported files."}
	${"2020-10-07"} | ${"--prerelease-files packages/**/CHANGELOG.adoc --files packages/**/package.json --release-version 1.3.8+e60e77fc --prerelease-files packages/**/CHANGELOG.md"} | ${"packages/**/package.json, packages/**/CHANGELOG.adoc, packages/**/CHANGELOG.md did not match any supported files."}
	${"2020-11-30"} | ${"--release-version 3.1.0-beta.2 --prerelease-files CHANGELOG.adoc CHANGELOG.md --files package.json *.adoc *.md"}                                              | ${"package.json, *.adoc, *.md, CHANGELOG.adoc, CHANGELOG.md did not match any supported files."}
	${"2021-03-25"} | ${"--release-files dist/CHANGELOG.md --prerelease-files dist/CHANGELOG.adoc --files dist/package.json --release-version release/11.4.0"}                         | ${"dist/package.json, dist/CHANGELOG.md did not match any supported files."}
	${"2021-06-04"} | ${"--release-version 2.2.3 --files packages/**/package.json --prerelease-files packages/**/CHANGELOG.adoc --release-files packages/**/CHANGELOG.md"}             | ${"packages/**/package.json, packages/**/CHANGELOG.md did not match any supported files."}
	${"2021-09-24"} | ${"--prerelease-files CHANGELOG.adoc --release-files CHANGELOG.md --files package.json --release-version 2.6.0-rc.0+ed7e32ad"}                                   | ${"package.json, CHANGELOG.adoc did not match any supported files."}
	${"2021-11-12"} | ${"--release-version 3.6.1+39609b2e --files packages/**/package.json --prerelease-files packages/**/CHANGELOG.adoc --release-files packages/**/CHANGELOG.md"}    | ${"packages/**/package.json, packages/**/CHANGELOG.adoc did not match any supported files."}
`(
...
describe.each`
	...
	${"2019-09-06"} | ${"--release-version release/0.0.7-alpha.1+6195eee8 --prerelease-files packages/**/*"}                                                 | ${[aNonPromotablePackageJson("packages/apples/package.json"), anIgnorableFileA("packages/apples/apple-releases.txt"), aPromotablePackageJsonC("packages/bananas/package.json"), anIgnorableFileB("packages/bananas/banana-releases.txt")]}              | ${["packages/apples/package.json must have a 'version' field."]}
	...
	${"2019-11-27"} | ${"--release-version v0.3.1 --release-files packages/**/*"}                                                                            | ${[aPromotablePackageJsonD("packages/apples/package.json"), anIgnorableFileA("packages/apples/apples.txt"), aNonPromotablePackageJson("packages/bananas/package.json"), anIgnorableFileB("packages/bananas/bananas.txt")]}                              | ${["packages/bananas/package.json must have a 'version' field."]}
...
describe.each`
	...
	${"2017-10-24"} | ${"--files package.json *.adoc --release-version v6.21.0-beta.3+d5405ecc"}                             | ${[aPromotablePackageJsonA("package.json"), anIgnorableFileB("CHANGES.adoc")]}                                                                                                                                                                         | ${[aPromotedPackageJsonA("package.json", "6.21.0-beta.3+d5405ecc")]}
	...
	${"2017-11-02"} | ${"--files *.adoc *.md package.json --release-version release/10.15.0"}                                | ${[anIgnorableFileA("RELEASES.adoc"), anIgnorableFileB("RELEASES.md"), aPromotablePackageJsonC("package.json")]}                                                                                                                                       | ${[aPromotedPackageJsonC("package.json", "10.15.0")]}
	...
	${"2017-12-07"} | ${"--files **/*.md **/package.json --release-version 19.0.0-beta.2"}                                   | ${[anIgnorableFileA("packages/apples/LOG.md"), aPromotableMarkdownChangelogD("packages/oranges/CHANGELOG.md"), aPromotablePackageJsonB("packages/oranges/package.json"), aPromotablePackageJsonD("packages/peaches/package.json")]}                    | ${[aPromotedMarkdownChangelogD("packages/oranges/CHANGELOG.md", "19.0.0-beta.2", "2017-12-07"), aPromotedPackageJsonB("packages/oranges/package.json", "19.0.0-beta.2"), aPromotedPackageJsonD("packages/peaches/package.json", "19.0.0-beta.2")]}
	...
	${"2019-05-13"} | ${"--release-version 2.1.0 --files packages/**/*"}                                                     | ${[aPromotablePackageJsonA("packages/apples/package.json"), anIgnorableFileA("packages/apples/RELEASES"), aPromotablePackageJsonB("packages/bananas/package.json"), anIgnorableFileB("packages/bananas/releases.txt")]}                                | ${[aPromotedPackageJsonA("packages/apples/package.json", "2.1.0"), aPromotedPackageJsonB("packages/bananas/package.json", "2.1.0")]}
`(
	"when all matching files can be promoted or ignored: $args",
...
describe.each`
	today           | args                                                                | files                                                                       | expectedWarning
	${"2017-01-02"} | ${"--files changelog.txt --release-version 0.9.1"}                  | ${[anIgnorableFileA("changelog.txt")]}                                      | ${"changelog.txt did not match any supported files."}
	${"2017-06-11"} | ${"--prerelease-files history.txt --release-version 1.2.0-next"}    | ${[anIgnorableFileA("history.txt")]}                                        | ${"history.txt did not match any supported files."}
	${"2017-10-22"} | ${"--release-files *.txt --release-version 4.0.1"}                  | ${[anIgnorableFileA("log.txt"), anIgnorableFileB("releases.txt")]}          | ${"*.txt did not match any supported files."}
	${"2018-04-03"} | ${"--files *.md --release-version v1.5.0-beta.3"}                   | ${[anIgnorableFileA("CHANGES.md"), anIgnorableFileB("README.md")]}          | ${"*.md did not match any supported files."}
	${"2018-08-14"} | ${"--prerelease-files CHANGELOG --release-version v3.3.0+ec7593ed"} | ${[anIgnorableFileB("CHANGELOG")]}                                          | ${"CHANGELOG did not match any supported files."}
	${"2018-10-25"} | ${"--release-files RELEASES --release-version v5.1.6"}              | ${[anIgnorableFileB("RELEASES")]}                                           | ${"RELEASES did not match any supported files."}
	${"2017-03-23"} | ${"--files *.adoc --release-version 1.0.0"}                         | ${[anIgnorableFileA("HISTORY.adoc")]}                                       | ${"*.adoc did not match any supported files."}
	${"2017-04-15"} | ${"--files lib/*.md --release-version 1.0.1-beta.1"}                | ${[anIgnorableFileA("lib/README.md"), anIgnorableFileB("lib/RELEASES.md")]} | ${"lib/*.md did not match any supported files."}
`(
	"when all matching files are ignorable: $args",
	(props: { today: DateString; args: string; files: Files; expectedWarning: string }) => {
		let actualExitCode: ExitCode
