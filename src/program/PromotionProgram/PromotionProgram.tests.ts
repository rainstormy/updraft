...
describe.each`
	...
	${"2018-06-26"} | ${"--release-version release/0.2.1 --prerelease-files lib/CHANGELOG.md lib/package.json"}                 | ${"No files set to be updated in release version 0.2.1, as it is not a prerelease."}
	...
	${"2018-11-19"} | ${"--release-version v3.1.0-beta.2 --release-files package.json *.adoc *.md"}                             | ${"No files set to be updated in release version 3.1.0-beta.2, as it is a prerelease."}
`(
...
describe.each`
	...
	${"2017-03-23"} | ${"--release-files CHANGELOG.adoc --release-version v1.0.0"}                           | ${[anEmptyAsciidocChangelog("CHANGELOG.adoc")]}                                                                                                                                                                                                         | ${["CHANGELOG.adoc must have an 'Unreleased' section."]}
	${"2017-04-15"} | ${"--prerelease-files lib/CHANGELOG.md --release-version release/1.0.1-beta.1"}        | ${[anEmptyMarkdownChangelog("lib/CHANGELOG.md")]}                                                                                                                                                                                                       | ${["lib/CHANGELOG.md must have an 'Unreleased' section."]}
	...
	${"2017-09-01"} | ${"--release-files docs/**/CHANGELOG.adoc --release-version release/0.1.4"}            | ${[aNonPromotableAsciidocChangelog("docs/apples/CHANGELOG.adoc"), aNonPromotableAsciidocChangelog("docs/bananas/CHANGELOG.adoc"), aNonPromotableAsciidocChangelog("docs/cranberries/CHANGELOG.adoc")]}                                                  | ${["docs/apples/CHANGELOG.adoc must have at least one item in the 'Unreleased' section.", "docs/bananas/CHANGELOG.adoc must have at least one item in the 'Unreleased' section.", "docs/cranberries/CHANGELOG.adoc must have at least one item in the 'Unreleased' section."]}
	${"2017-09-04"} | ${"--prerelease-files build/CHANGELOG.md --release-version v1.12.0+2536770a"}          | ${[aNonPromotableMarkdownChangelog("build/CHANGELOG.md")]}                                                                                                                                                                                              | ${["build/CHANGELOG.md must have at least one item in the 'Unreleased' section."]}
	...
	${"2017-12-14"} | ${"--files CHANGELOG.adoc package.json --release-version v9.0.0"}                      | ${[anEmptyAsciidocChangelog("CHANGELOG.adoc"), aNonPromotablePackageJson("package.json")]}                                                                                                                                                              | ${["CHANGELOG.adoc must have an 'Unreleased' section.", "package.json must have a 'version' field."]}
