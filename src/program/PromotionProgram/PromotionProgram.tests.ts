...
describe.each`
	...
	${"2018-03-10"} | ${"--prerelease-files CHANGELOG.md --release-version 1.7.1"}                                              | ${"No files set to be updated in release version 1.7.1, as it is not a prerelease."}
	${"2018-06-26"} | ${"--release-version 0.2.1 --prerelease-files lib/CHANGELOG.md lib/package.json"}                         | ${"No files set to be updated in release version 0.2.1, as it is not a prerelease."}
	...
	${"2018-11-19"} | ${"--release-version 3.1.0-beta.2 --release-files package.json *.adoc *.md"}                              | ${"No files set to be updated in release version 3.1.0-beta.2, as it is a prerelease."}
`(
	"when there are no files scheduled for update: $args",
	(props: {
		today: DateString
		args: string
...
describe.each`
	...
	${"2017-07-03"} | ${"--release-version 1.0.4 --files package.json CHANGELOG.adoc"}                                                                                              | ${"package.json, CHANGELOG.adoc did not match any files."}
	${"2017-08-21"} | ${"--files packages/**/CHANGELOG.md packages/**/package.json --release-version 0.7.9+8d1de5a9"}                                                               | ${"packages/**/CHANGELOG.md, packages/**/package.json did not match any files."}
	...
	${"2018-11-19"} | ${"--release-version 3.1.0-beta.2 --prerelease-files package.json *.adoc *.md"}                                                                               | ${"package.json, *.adoc, *.md did not match any files."}
	...
	${"2020-04-03"} | ${"--files CHANGELOG.md --release-version 1.7.1 --release-files package.json"}                                                                                | ${"CHANGELOG.md, package.json did not match any files."}
	${"2020-07-24"} | ${"--release-version 0.2.1 --release-files lib/CHANGELOG.adoc --files lib/CHANGELOG.md lib/package.json"}                                                     | ${"lib/CHANGELOG.md, lib/package.json, lib/CHANGELOG.adoc did not match any files."}
	${"2020-10-07"} | ${"--files packages/**/CHANGELOG.adoc packages/**/package.json --release-version 1.3.8+e60e77fc --prerelease-files packages/**/CHANGELOG.md"}                 | ${"packages/**/CHANGELOG.adoc, packages/**/package.json, packages/**/CHANGELOG.md did not match any files."}
	...
	${"2021-03-25"} | ${"--release-files dist/CHANGELOG.md --prerelease-files dist/CHANGELOG.adoc --files dist/package.json --release-version 11.4.0"}                              | ${"dist/package.json, dist/CHANGELOG.md did not match any files."}
...
describe.each`
	...
	${"2017-03-23"} | ${"--release-files CHANGELOG.adoc --release-version 1.0.0"}                            | ${[anEmptyAsciidocChangelog("CHANGELOG.adoc")]}                                                                                                                                                                                                         | ${["CHANGELOG.adoc must have an 'Unreleased' section."]}
	${"2017-04-15"} | ${"--prerelease-files lib/CHANGELOG.md --release-version 1.0.1-beta.1"}                | ${[anEmptyMarkdownChangelog("lib/CHANGELOG.md")]}                                                                                                                                                                                                       | ${["lib/CHANGELOG.md must have an 'Unreleased' section."]}
	...
	${"2017-09-01"} | ${"--release-files docs/**/CHANGELOG.adoc --release-version 0.1.4"}                    | ${[aNonPromotableAsciidocChangelog("docs/apples/CHANGELOG.adoc"), aNonPromotableAsciidocChangelog("docs/bananas/CHANGELOG.adoc"), aNonPromotableAsciidocChangelog("docs/cranberries/CHANGELOG.adoc")]}                                                  | ${["docs/apples/CHANGELOG.adoc must have at least one item in the 'Unreleased' section.", "docs/bananas/CHANGELOG.adoc must have at least one item in the 'Unreleased' section.", "docs/cranberries/CHANGELOG.adoc must have at least one item in the 'Unreleased' section."]}
	${"2017-09-04"} | ${"--prerelease-files build/CHANGELOG.md --release-version 1.12.0+2536770a"}           | ${[aNonPromotableMarkdownChangelog("build/CHANGELOG.md")]}                                                                                                                                                                                              | ${["build/CHANGELOG.md must have at least one item in the 'Unreleased' section."]}
